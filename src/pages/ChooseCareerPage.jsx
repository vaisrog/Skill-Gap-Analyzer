    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-6 space-y-6 overflow-y-auto">
          ...
          {currentTarget && (
            <section className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-5 text-white shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-lg font-extrabold">{currentTarget.title}</h2>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/analysis"
                  className="px-3.5 py-2 bg-white text-blue-700 hover:bg-blue-50 text-xs font-bold rounded-xl shadow-sm transition inline-flex items-center gap-1.5"
                >
                  View Gap Analysis
