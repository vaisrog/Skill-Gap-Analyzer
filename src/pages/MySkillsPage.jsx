              ...
              <form onSubmit={handleAddSkill} className="grid sm:grid-cols-12 gap-3.5 items-end">
                <div className="sm:col-span-6">
                  ...
                  <select
                    ...
                    required
                    className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition"
                  >
                ...
                <div className="sm:col-span-2">
                  <button
                    ...
                    className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-bold text-xs rounded-xl shadow-sm transition flex items-center justify-center gap-1.5"
                  >
                            ...
                            {isEditing ? (
                              <div className="flex items-center gap-2">
                                <select
                                  ...
                                  className="px-2 py-1 bg-white border border-blue-400 rounded-lg text-xs font-semibold focus:outline-none"
                                >
                                  {PROFICIENCY_OPTIONS.map((opt) => (
                                    <option key={opt.level} value={opt.level}>
                                      {opt.label}
                              ...
                              <div className="flex items-center gap-2">
                                <span className="font-bold text-blue-700 bg-blue-50 border border-blue-200 px-2.5 py-0.5 rounded-full">
